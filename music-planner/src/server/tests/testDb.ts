 ...
 *
 * Creates an in-memory SQLite Sequelize instance and re-initialises all models
 * against it, so tests do not require a running PostgreSQL server.
 *
 * Usage:
...
/** Re-initialise every model against the in-memory SQLite instance. */
